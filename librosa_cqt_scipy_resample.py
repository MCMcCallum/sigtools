...
# NOTE [matt.c.mccallum 08.20.18]: This file is a patch on the librosa library that may be used
# in place of librosa's CQT functionality. The only change here is to allow the use of the scipy
# resampling code, as resampy has issues working on at least some Amazon EC2 instances.
